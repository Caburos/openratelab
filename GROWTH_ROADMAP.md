...
- [ ] Set a sustainable editorial cadence (2–4 new posts/month is realistic for one agency)
...
- [ ] Internal linking pass: blog posts ↔ relevant case studies ↔ service sections (topical authority signal)
- [ ] Add author/expertise bylines — currently no author identity shown anywhere (E-E-A-T signal, also needed for Phase 4 entity consistency)
...
- [ ] Checked internal linking (blog ↔ case studies) 2026-08-21 — already solid, not actually a gap. Every blog post links to ≥1 case study, 11/12 case studies link to 2 blog posts each. Only `pet-wellness-brand.html` has 1 instead of 2 — minor, not worth a dedicated pass.
...
- [ ] Extend FAQPage + Article + BreadcrumbList "triple stack" schema to every blog/case-study page, not just the homepage
