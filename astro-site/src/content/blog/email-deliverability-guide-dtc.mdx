...
- **SPF (Sender Policy Framework):** A list of servers authorized to send email on your domain's behalf. Without it, a receiving server has no way to confirm your ESP is actually allowed to send as you.
